...
export default class DataSourceSelector extends LightningElement {
  ...
  //navigation vers la source de selection  File Upload
  handleCSV() { this.selectedSource = "CSV";}

  //navigation vers la source de selection  Query Builder
  handleSOQL() { this.selectedSource = "SOQL"; }
